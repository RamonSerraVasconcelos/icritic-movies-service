...
The icritic-movies-service is a microservice from this application which aims to manage all movies related requests.
## Features

- Management of all movies and data related to them
